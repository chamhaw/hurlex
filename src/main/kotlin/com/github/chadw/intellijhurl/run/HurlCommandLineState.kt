...
class HurlCommandLineState(
    ...
    private fun buildSectionScript(
        ...
        sb.appendLine("    for entry in data:")
        sb.appendLine("        for c in entry.get('captures', []):")
        sb.appendLine("            v = c['value']")
        sb.appendLine("            if isinstance(v, bool):")
        sb.appendLine("                v = str(v).lower()")
        sb.appendLine("            print('--variable')  ")
        sb.appendLine("            print(str(c['name']) + '=' + str(v))")
